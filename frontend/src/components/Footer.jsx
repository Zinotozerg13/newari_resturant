    ...
    <div ref={footerRef}> 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-orange-300">For Contact: +977-1-NEWARI</p>
              <p className="text-orange-300">ron.ranjit998@gmail.com</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-red-800 text-orange-400 py-8">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p>&copy; 2024 Newa Baji Restaurant. सबै अधिकार सुरक्षित। Preserving tradition, one meal at a time.</p>
        </div>
      </footer></div>
  )
}
